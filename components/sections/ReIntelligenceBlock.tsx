...
const benefits: React.ReactNode[] = [
  ...
  <>2 consultas de 30 min con especialistas de la <Link href="/biobuilders" className="underline decoration-rl-red/40 hover:decoration-rl-red transition-colors">red de Bio/Builders</Link></>,
