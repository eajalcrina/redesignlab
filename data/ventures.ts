...
El programa central es un curso de 8 semanas de aprendizaje dual: DeepTech aplicado + Business Design, donde cada participante construye un proyecto de bionegocio real mientras aprende. Trabaja sobre casos reales de la Amazonía y ecosistemas críticos, incluye modelos financieros para territorios complejos, gobernanza de origen y protección de biodiversidad, y otorga membresía a la comunidad BBS. Diseñado y dirigido por Eddie Ajalcriña y Lorenzo Ortiz.`,
    ...
    tags: ['Bionegocios', 'Formación ejecutiva', 'DeepTech', 'Business Design', 'Biodiversidad', 'LATAM'],
  },
  {
    name: 'Thousandfold',
