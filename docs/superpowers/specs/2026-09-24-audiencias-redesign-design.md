...
| 05 | Conocimiento | Crema | Texto + "Ver todos los recursos →" (`/conocimiento`). A la derecha, 3 PDFs con portada: BIRF, Innovation Matrix, Re·IA. Se descargan mediante el mismo formulario de `/conocimiento` (`ResourceDrawer` → Brevo/Sheets), para no perder la captura de contactos (decisión del plan, 2026-09-24). |
