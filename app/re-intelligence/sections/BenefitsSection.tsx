    ...
    <>
      <SectionReveal>
        <p className="text-body-lg text-text-secondary max-w-3xl mb-12">
          La bolsa de 4 horas mensuales es el corazón de ambas versiones. Lo que cambia es el material que llega a esas sesiones y cuánto trabajo de análisis hace Redesign Lab antes y después.
        </p>
      </SectionReveal>
        ...
        <SectionReveal delay={0.2}>
          <div className="border-2 border-rl-red bg-rl-red/5 rounded p-8 md:p-10 h-full">
            ...
            <p className="text-body-sm text-text-secondary italic mt-8 pt-6 border-t border-border-light">
              La integración de los datos del negocio hace que cada hora de sesión llegue con análisis ya hecho. No se gasta tiempo nivelando contexto.
            </p>
          </div>
        </SectionReveal>
      </div>
